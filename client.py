...
rsa_key_B = RSA.generate(2048)

#Generate the purchaser's public key from the RSA key
pub_key_purchaser = rsa_key_B.publickey()
pubKeyPEM_purchaser = pub_key_purchaser.exportKey()

#Obtain purchaser's private key
privKeyPEM_purchaser = rsa_key_B.exportKey()
